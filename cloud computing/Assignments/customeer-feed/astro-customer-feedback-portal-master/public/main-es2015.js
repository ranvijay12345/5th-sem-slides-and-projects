...
/* harmony import */ var _pages_review_review_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/review/review.component */ "./src/app/pages/review/review.component.ts");
/* harmony import */ var _pages_review_new_review_new_review_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/review/new-review/new-review.component */ "./src/app/pages/review/new-review/new-review.component.ts");
...
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_user_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"])); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 20, vars: 0, consts: [["size", "large"], [1, "loading"], ["id", "main-wrapper"], ["data-navbarbg", "skin5", 1, "topbar"], [1, "navbar", "top-navbar", "navbar-expand-md", "navbar-dark"], [2, "margin-left", "20px"], [1, "page-wrapper"], [1, "container-fluid"], [1, "row"], [1, "col-12"], [1, "card"], [1, "footer", "text-center"], ["href", ""]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _services_review_review_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/review/review.service */ "./src/app/services/review/review.service.ts");
/* harmony import */ var _pages_review_new_review_new_review_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./pages/review/new-review/new-review.component */ "./src/app/pages/review/new-review/new-review.component.ts");
...
/* harmony import */ var _pages_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pages/page-not-found/page-not-found.component */ "./src/app/pages/page-not-found/page-not-found.component.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        _services_review_review_service__WEBPACK_IMPORTED_MODULE_8__["ReviewService"]
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        _pages_review_new_review_new_review_component__WEBPACK_IMPORTED_MODULE_9__["NewReviewComponent"],
...
/* harmony import */ var src_app_services_review_review_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/review/review.service */ "./src/app/services/review/review.service.ts");
...
function NewReviewComponent_div_20_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Input is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NewReviewComponent_div_20_div_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Invalid email address");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NewReviewComponent_div_20_Template(rf, ctx) { if (rf & 1) {
...
function NewReviewComponent_div_25_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Input is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NewReviewComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
...
function NewReviewComponent_div_26_option_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 21);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const rt_r9 = ctx.$implicit;
...
function NewReviewComponent_div_26_div_7_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Input is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NewReviewComponent_div_26_div_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
...
function NewReviewComponent_div_26_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function NewReviewComponent_div_26_Template_select_change_3_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.changeReview($event); });
...
function NewReviewComponent_div_31_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Input is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NewReviewComponent_div_31_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
...
class NewReviewComponent {
    constructor(formBuilder, reviewService, router, route, spinner) {
...
NewReviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewReviewComponent, selectors: [["app-new-review"]], decls: 34, vars: 14, consts: [[1, "card-body"], [1, "card-title"], [1, "row"], [1, "container"], [1, "col"], ["type", "button", 1, "btn", "btn-secondary", 2, "float", "right", 3, "click"], [1, "row", "custom-wrapper"], [1, "col-md-12"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "text", "formControlName", "email", "placeholder", "eg: john@hotmail.com", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["formControlName", "title", "placeholder", "Title", 1, "form-control", 3, "ngClass"], ["class", "form-group", 4, "ngIf"], ["rows", "5", "formControlName", "description", "placeholder", "Please explain about your review...", 1, "form-control", 3, "ngClass"], ["type", "submit", 1, "btn", "btn-primary", 2, "float", "right"], [1, "invalid-feedback"], [4, "ngIf"], ["formControlName", "review_type", 1, "custom-select", 3, "ngClass", "change"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function NewReviewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewReviewComponent_Template_button_click_8_listener() { return ctx.goToReview(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NewReviewComponent_Template_form_ngSubmit_12_listener() { return ctx.onSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewReviewComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_services_review_review_service__WEBPACK_IMPORTED_MODULE_3__["ReviewService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }, { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"] }]; }, null); })();
...
function ReviewComponent_div_23_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReviewComponent_div_23_div_2_Template_i_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const p_r2 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r3.addLike(p_r2.review_id, p_r2.total_like, p_r2.total_dislike); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReviewComponent_div_23_div_2_Template_i_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const p_r2 = ctx.$implicit; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r5.addDislike(p_r2.review_id, p_r2.total_like, p_r2.total_dislike); });
...
function ReviewComponent_div_23_Template(rf, ctx) { if (rf & 1) {
...
class ReviewComponent {
    constructor(reviewService, router, route, formBuilder, spinner) {
        this.reviewService = reviewService;
        this.router = router;
        this.route = route;
        this.formBuilder = formBuilder;
...
ReviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ReviewComponent, selectors: [["app-review"]], decls: 24, vars: 2, consts: [[1, "card-body"], [1, "card-title"], [1, "row"], [1, "container"], [1, "col"], ["type", "button", 1, "btn", "btn-primary", 2, "float", "right", 3, "click"], [3, "formGroup", "ngSubmit"], [1, "col-10"], ["type", "text", "placeholder", "Search by Email", "formControlName", "email", "autofocus", "", 1, "form-control"], [1, "col-2"], ["type", "submit", 1, "btn", "btn-primary", 2, "float", "right", "margin-left", "5px"], ["type", "button", 1, "btn", "btn-secondary", 2, "float", "right", 3, "click"], ["class", "bg-white rounded box-shadow", 4, "ngIf"], [1, "bg-white", "rounded", "box-shadow"], [1, "border-bottom", "border-gray", "pb-2", "mb-0"], ["class", "media text-muted pt-3", 4, "ngFor", "ngForOf"], [1, "media", "text-muted", "pt-3"], ["data-src", "holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1", "alt", "", 1, "mr-2", "rounded"], [1, "media-body", "pb-3", "mb-0", "small", "lh-125", "border-bottom", "border-gray"], [1, "d-flex", "justify-content-between", "align-items-center", "w-100"], [1, "text-gray-dark", "review-desc"], [1, "d-block", "review-title"], [1, "d-block", "review-description"], [1, "like"], [1, "glyphicon", "glyphicon-thumbs-down", 3, "click"], ["src", "https://img.icons8.com/ios/50/000000/good-quality.png"], [1, "glyphicon", "glyphicon-thumbs-up", 3, "click"], ["src", "https://img.icons8.com/ios/50/000000/poor-quality.png"]], template: function ReviewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReviewComponent_Template_button_click_8_listener() { return ctx.addNewReview(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ReviewComponent_Template_form_ngSubmit_11_listener() { return ctx.onSubmit(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "div", 2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReviewComponent_Template_button_click_18_listener() { return ctx.reset(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReviewComponent, [{
    ...
    }], function () { return [{ type: src_app_services_review_review_service__WEBPACK_IMPORTED_MODULE_3__["ReviewService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"] }]; }, null); })();
...
class ReviewService {
    ...
    getAll() {
        return new Promise(resolve => {
            this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/review/get-all`).subscribe((response) => {
                if (response.error) {
    ...
    addNew(req) {
        return new Promise(resolve => {
            this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/review/add-new`, req.data).subscribe((response) => {
                if (response.error) {
                    console.error(response);
                    return;
                }
    ...
    updateRating(req) {
        console.log(req);
        return new Promise(resolve => {
            this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/review/update-rating`, req).subscribe((response) => {
                if (response.error) {
                    console.error(response);
                    return;
                }
    ...
    getReviewTypes() {
        return new Promise(resolve => {
            this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/review/get-review-types`).subscribe((response) => {
                if (response.error) {
                    console.error(response);
                    return;
                }
    ...
    getReviewByEmail(req) {
        return new Promise(resolve => {
            console.log(req);
            this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/review/get-review-by-email/${req.email}`).subscribe((response) => {
                if (response.error) {
                    console.error(response);
                    return;
                }
...
class UserService {
    ...
    getAll() {
        return new Promise(resolve => {
            this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL}/user/get-all`).subscribe((response) => {
                if (response.error) {
                    console.error(response);
                    return;
                }
...
module.exports = __webpack_require__(/*! C:\wamp64\www\workspace\web\angular\astro-customer-feedback-portal\angular\src\main.ts */"./src/main.ts");
